...
check_ip_permission() {
    VPS_IP=$(get_vps_ip)
    ACCESS_URL="https://raw.githubusercontent.com/angga04k/Xray/refs/heads/main/ip"
    ...
    if [ -n "$MATCH" ]; then
        ...
        echo "Silakan hubungi @anggaalfarizi atau gunakan script asli dari dugong-lewat."
        exit 1
    fi
}
...
wget -q -O /usr/local/bin/wireproxy https://raw.githubusercontent.com/angga04k/Xray/refs/heads/main/wireproxy
...
API_EMAIL="super.anggaaa@gmail.com"
API_KEY="d3e27af474728cd2c31ba76a433b1bc90cd51"
...
install_acme_sh() {
    ...
    export CF_Email="super.anggaaa@gmail.com"
    export CF_Key="d3e27af474728cd2c31ba76a433b1bc90cd51"
...
XRAY_CONFIG=https://raw.githubusercontent.com/angga04k/Xray/refs/heads/main/config
...
wget -q -O /var/www/html/index.html https://https://raw.githubusercontent.com/angga04k/Xray/refs/heads/main/index.html
wget -q -O /etc/nginx/nginx.conf https://https://raw.githubusercontent.com/angga04k/Xray/refs/heads/main/nginx.conf
domain=$(cat /usr/local/etc/xray/dns/domain)
...
cd /usr/bin
GITHUB=https://raw.githubusercontent.com/angga04k/Xray/refs/heads/main/
